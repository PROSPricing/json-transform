...
public class SimpleArrayTest
{
    ...
    {
        jsonSource = JunitTools.readFile(pathToJson + "/SimpleArraySource.json");
        jsonTransform = JunitTools.readFile(pathToJson + "/SimpleArrayMap.json");
        jsonTarget = JunitTools.readFile(pathToJson + "/SimpleArrayTarget.json");
